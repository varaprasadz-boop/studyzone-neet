...
<?php if (!$classId): /* ---------- pick class ---------- */ ?>
  ...
  <?php if ($admin && is_file(__DIR__ . '/imports/study-bundles.json')): ?>
    <div class="toolbar">
      <a class="btn ghost" href="study_import.php"><?php echo icon('download'); ?> Import packaged study material</a>
    </div>
  <?php endif; ?>
  <div class="grid">
